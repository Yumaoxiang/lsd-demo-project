...
![image.png](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/1X3lE5jmDrMAKlJb/img/1d3a7e94-e0f2-4d6b-9be6-b3fdf6664860.png)

如下图所示：AppOTA.bin就是APP镜像的OTA升级包。

![image.png](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/1X3lE5jmDrMAKlJb/img/38ac8f35-e97d-41dc-8a03-06e0b72d96df.png)

APP全量升级原理说明

升级的执行流程在bootloader阶段，这样在升级过程中异常掉电，系统启动后还会继续进行APP的升级，保证升级掉电系统不变砖。

![相关流程图-流程图.png](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/1X3lE5jmDrMAKlJb/img/47415a53-df14-41ed-a528-820aca82dbc5.png)
...
![image.png](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/1X3lE5jmDrMAKlJb/img/b18c8d14-4655-4fb7-bea6-bda08a44f59f.png)

2.导出时的文件系统地址查看方式：

![image.png](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/1X3lE5jmDrMAKlJb/img/03924c69-5580-42d7-b389-4b0885ab6201.png)
...
![image.png](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/1X3lE5jmDrMAKlJb/img/3d566ba4-0dfc-4dfa-ac76-ef74a3d82e75.png)

4.将新的文件系统bin烧录到系统中。

![image.png](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/1X3lE5jmDrMAKlJb/img/9007e695-72b1-4766-9296-790be6e5728f.png)

5.复位设备进行包检查。

![image.png](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/1X3lE5jmDrMAKlJb/img/bb14b436-4c5f-43f0-a3b1-f8afc0c7fdb8.png)

6.debug口日志，提示升级成功。

![image.png](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/1X3lE5jmDrMAKlJb/img/6436cf4e-9565-4901-8f79-2d34cc92f3a9.png)
...
![image.png](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/1X3lE5jmDrMAKlJb/img/b51dcc1f-6d4f-4384-b2ef-faf4e2b0ce9c.png)
